...
b1 = Button(root, width=20, height=10, command=lambda: sign(1))
b1.grid(row=1, column=1)
b2 = Button(root, width=20, height=10, command=lambda: sign(2))
b2.grid(row=1, column=2)
b3 = Button(root, width=20, height=10, command=lambda: sign(3))
b3.grid(row=1, column=3)
b4 = Button(root, width=20, height=10, command=lambda: sign(4))
b4.grid(row=2, column=1)
b5 = Button(root, width=20, height=10, command=lambda: sign(5))
b5.grid(row=2, column=2)
b6 = Button(root, width=20, height=10, command=lambda: sign(6))
b6.grid(row=2, column=3)
b7 = Button(root, width=20, height=10, command=lambda: sign(7))
b7.grid(row=3, column=1)
b8 = Button(root, width=20, height=10, command=lambda: sign(8))
